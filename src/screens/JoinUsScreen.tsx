    ...
    return (
        <View style={{ flex: 1, backgroundColor: AppColorsTheme2.offWhite, padding: horizontalScale(16) }}>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, flex: 1 }}>
                ...
                <AppText weight="700" alignItems="flex-start">join our team</AppText>
                <AppText alignItems="flex-start">and you can go online with our map</AppText>

                <View style={{ marginVertical: 20 }}>
                    <View style={{ flexDirection: "row", }}>
                        <AppIcon name='info-with-circle' type="Entypo" />
                        <AppText style={{ marginLeft: 8 }} weight='700' > How to Apply for it </AppText>
                    </View>
