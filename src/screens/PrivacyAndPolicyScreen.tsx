      ...
      <ScrollView style={styles.scrollContainer}>
        <View style={{ padding: 24 }}>
          ...
          >
            ...
            shared and/or collect in Yamak. This policy is not applicable to any
            information collected offline or via channels other than this website.
            Our Privacy Policy was created with the help of the Free Privacy
            Policy Generator. Consent By using our website, you hereby consent to
            ...
            fraud Log Files Yamak follows a standard procedure of using log
            ...
            gathering demographic information. Cookies and Web Beacons Like any
            other website, Yamak uses 'cookies'. These cookies are used to store
            ...
            based on visitors' browser type and/or other information. Advertising
            Partners Privacy Policies You may consult this list to find the
            Privacy Policy for each of the advertising partners of Yamak.
            Third-party ad servers or ad networks uses technologies like cookies,
            JavaScript, or Web Beacons that are used in their respective
            advertisements and links that appear on Yamak, which are sent
            directly to users' browser. They automatically receive your IP address
            when this occurs. These technologies are used to measure the
            effectiveness of their advertising campaigns and/or to personalize the
            advertising content that you see on websites that you visit. Note that
            Yamak has no access to or control over these cookies that are used
            by third-party advertisers. Third Party Privacy Policies Yamak's
            ...
            monitor and guide their online activity. Yamak does not knowingly
